...
- Executed a final push and ensured web deployment was working right.
...
Being web development, and specially web design, one of my hobbies I have quite enjoyed this project. During the development of the web I was able to review all HTML and CSS concepts I had studied in the past and had forgotten. Thanks to working with git, I've been able to understand the importance of structure and following a methodology while developing a project of this kind. One thing I really liked was deploying the web using GitHub pages, something I had never done before. If I had to take one lesson from the project, it is that there is no better way to learn to program, than by programming, that is, practical content is better learnt through practical work.
